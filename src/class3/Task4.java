...
*/
        ...
        System.out.println("the addition of 2 numbers"+number1+" and "+number2+" is equali to " +addition);
        System.out.println("the subtraction of "+number1+"and"+number2+"is equal to");
